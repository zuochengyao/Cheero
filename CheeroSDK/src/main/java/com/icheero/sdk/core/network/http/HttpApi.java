...
public class HttpApi
{
     ...
     */
    public static final String MEDIA_TYPE_NORMAL = "com.icheero.application/x-www-form-urlencoded;charset=utf-8";
    /**
     ...
     */
    public static final String MEDIA_TYPE_STREAM = "com.icheero.application/octet-stream";
    /**
     * 只能提交文本参数和字符集
     */
     ...
     * 只能提交json格式参数
     */
    public static final String MEDIA_TYPE_JSON = "com.icheero.application/json;charset=utf-8";
