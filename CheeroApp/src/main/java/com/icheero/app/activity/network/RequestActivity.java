...
import com.icheero.sdk.core.network.http.api.CheeroResponse;
...
public class RequestActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        findViewById(R.id.request_btn).setOnClickListener(v -> CheeroApi.helloWorld("http://10.155.2.130:8080/cheero/hello.action", map, new CheeroResponse<String>()
        {
            @Override
            public void success(CheeroRequest request, String data)
            {
