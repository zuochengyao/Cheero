...
public class JniActivity extends BaseActivity
{
    ...
    @OnClick({R.id.jni_hello_world, R.id.jni_call_java_method, R.id.jni_call_java_non_virtual_method, R.id.jni_get_system_data_time, R.id.jni_cpp_string, R.id.jni_cpp_array})
