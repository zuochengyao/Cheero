...
{
    private final String PATH_VIDEO = FileManager.DIR_EXTERNAL_FILES_VIDEO + "/jctq.mp4";
    private final String PATH_AUDIO = FileManager.DIR_EXTERNAL_FILES_AUDIO + "/jctq.aac";
